...
-(void)setExternalLabelValue:(UILabel *)externalLabelValue
{
    _externalLabelValue = externalLabelValue;
...
//    self.minimumTrackTintColor = KBATintColor;
//    self.maximumTrackTintColor = KBATintColor;
}
...
- (void)positionAndUpdatePopUpView
{
    ...
    NSString *string;
    if (_externalLabelValue) {
        string = self.externalLabelValue.text;
    }
    else{
        string = [_numberFormatter stringFromNumber:@(self.value)];
    }
...
- (void)calculatePopUpViewSize
{
    ...
    if (_externalLabelValue) {
        ...
        string = [_numberFormatter stringFromNumber:@(value)];
    }
    [[self.attributedString mutableString] setString:string];
